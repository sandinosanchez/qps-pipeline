...
class Repository extends BaseObject {
    ...
    private void generateCiItems() {
        context.stage("Create Repository") {
            ...
            registerObject("pull_request_job", new PullRequestJobFactory(repoFolder, getOnPullRequestScript(), "onPullRequest-" + Configuration.get(REPO), pullRequestPipelineJobDescription, scmHost, scmOrg, Configuration.get(REPO), branch, gitUrl, this.scmWebHookArgs))
